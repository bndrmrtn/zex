...
func (r *router) Add(method, path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
...
func (r *router) Get(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodGet, path, handler, middlewares...)
}

func (r *router) Post(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPost, path, handler, middlewares...)
}

func (r *router) Put(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPut, path, handler, middlewares...)
}

func (r *router) Delete(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodDelete, path, handler, middlewares...)
}

func (r *router) Patch(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPatch, path, handler, middlewares...)
}

func (r *router) Options(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodOptions, path, handler, middlewares...)
}

func (r *router) All(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
...
func (r *routerGroup) Add(method, p string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.router.Add(method, path.Join(r.prefix, p), handler, append(r.middlewares, middlewares...)...)
}

func (r *routerGroup) Get(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodGet, path, handler, middlewares...)
}

func (r *routerGroup) Post(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPost, path, handler, middlewares...)
}

func (r *routerGroup) Put(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPut, path, handler, middlewares...)
}

func (r *routerGroup) Delete(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodDelete, path, handler, middlewares...)
}

func (r *routerGroup) Patch(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodPatch, path, handler, middlewares...)
}

func (r *routerGroup) Options(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add(http.MethodOptions, path, handler, middlewares...)
}

func (r *routerGroup) All(path string, handler http.HandlerFunc, middlewares ...MiddlewareFunc) Route {
	return r.Add("*", path, handler, middlewares...)
}
